...
fn main() {
    ...
    score[e_cord.0 as usize][e_cord.1 as usize] = 0;
    q.push_back(e_cord);
    ...
    while !q.is_empty() {
        ...
        for dir in dirs {
            ...
            if in_limit(new_cord, x_l as i32, y_l as i32) {
                ...
                if matrix[new_cord.0][new_cord.1] as u8 + 1 >= (matrix[cord.0][cord.1] as u8)
